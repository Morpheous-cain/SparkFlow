  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      setReportItems([
        ...
        { id: 'BI-002', metric: 'Paid Transactions (Today)',value: String(txCount),                            status: 'Live' },
        { id: 'BI-003', metric: 'Total Expenses (MTD)',     value: `KES ${Number(expenses).toLocaleString()}`, status: 'Live' },
        { id: 'BI-004', metric: 'Net Profit (MTD)',         value: `KES ${Number(profit).toLocaleString()}`,   status: 'Live' },
        { id: 'BI-005', metric: 'Bay Utilisation',          value: `${bayUtil}%`,                              status: 'Live' },
